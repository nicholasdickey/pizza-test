...
4. Create a Pizza Card component

    Goal create a PizzaCard component.

    Will show the size selection, base price based on size selection (default Medium), Toppings multi-selection and derived total price.

    When a menu item is selected, show the "Add to Cart" button. 

    Use a pure function for the price calculation. Memoize.
